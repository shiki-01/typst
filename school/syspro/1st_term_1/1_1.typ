...
#table(
  columns: 4,
  [],[イベントA],[イベントB],[イベントC],
  [状態A],[アクティビティA],[\*],[アクティビティC],
  [状態B],[アクティビティA],[アクティビティB],[\*],
  [状態C],[\*],[アクティビティB],[アクティビティC],
)

4. 次のかっこの中に当てはまる言葉を書きなさい

情報システムの設計は、利用者と開発者との間で、これから設計する情報システムについて調査や要求分析（利用者との意見交換・情報収集）をすることから始まる。利用者との意見交換や情報収集する方法としては、#light[資料調査]調査、#light[観察調査]調査、#light[ヒヤリング（面接）]調査がある。このような調査を実施し、利用者と開発者との間での共通理解をしていく。共通理解を進めていく手法として、#light[機能要求]と#light[非機能要求]の確認、#light[機能改装図]、#light[ユースケース図]の作成がある。\
